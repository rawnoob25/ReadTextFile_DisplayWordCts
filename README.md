## This repo contains files that show how to use javascript to read from a text file, and to display counts of words in the text file (in descending order of frequency). 
